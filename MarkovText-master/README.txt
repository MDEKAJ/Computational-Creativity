...
<BR><code>python genMarkovDict.py -k 2 -i "Data - Obama\Obama - 20080603" -d obamadict.txt </code>


python3 genMarkovDict.py -k 2 -i "Data - Obama\*.*" -d obamadict.txt
python3 genMarkovDict.py -k 2 -i "Data - Obama\Obama - 20080603" -d markovdict.txt
...
python3 genMarkovText.py -w 20 -n 5 -d markovdict.txt


python3 genMarkovText.py -w 100 -n 10 -d newdict2.txt
